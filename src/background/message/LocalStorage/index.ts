import { localStorageMessageDataType } from './types'
import CounterDespatcher from './Counter'
import MemosDespatcher from './Memos'

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export default function (localStorage: localStorageMessageDataType, sender: chrome.runtime.MessageSender, sendResponse: (response?: any) => void): void {
